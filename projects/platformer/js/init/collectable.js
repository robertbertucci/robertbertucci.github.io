(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 475, 100, 6, 1.5);
        collectable.create(type.max, 500, 100, 6, 1.5);
        collectable.create(type.grace, 525, 100, 6, 1.5);
        collectable.create(type.kennedi, 550, 100, 6, 1.5);
